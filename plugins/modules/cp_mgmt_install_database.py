...
options:
  targets:
    description:
      - Checkpoint host(s) with one or more Management Software Blades enabled.
        The targets can be identified by their name or unique identifier.
    type: list
    required: True
extends_documentation_fragment: checkpoint.mgmt.checkpoint_commands
"""
...
RETURN = """
cp_mgmt_install_database:
  description: The database installation tasks and targets.
  returned: always
  type: dict
"""
