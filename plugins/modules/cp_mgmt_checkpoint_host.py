...
short_description: Manages checkpoint-host objects on Check Point over Web Services API
description:
    - Manages checkpoint-host objects on Check Point devices including creating, updating and removing objects.
...
options:
      ...
      mask_length:
        description:
          - IPv4 or IPv6 network mask length.
            If both masks are required use mask_length4 and mask_length6 fields explicitly. Instead of IPv4 mask length it is possible to specify IPv4 mask itself in subnet_mask field.
        type: int
      mask_length4:
        description:
  ...
  ip_address:
    description:
      - IPv4 or IPv6 address.
        If both addresses are required use ipv4_address and ipv6_address fields explicitly.
    type: str
  ipv4_address:
    description:
      - IPv4 address.
  ...
  nat_settings:
    ...
    suboptions:
      ...
      hide_behind:
        description:
          - Hide behind method.
            This parameter is forbidden in case "method" parameter is "static".
        type: str
  ...
  management_blades:
    ...
    suboptions:
      ...
      smart_event_server:
        description:
          - Enable SmartEvent server.
            When activating SmartEvent server, blades 'logging_and_status' and 'smart_event_correlation' should be set to True.
            To complete SmartEvent configuration, perform Install Database or Install Policy on your Security Management servers and Log servers.
            Activating SmartEvent Server is not recommended in Management High Availability environment. For more information refer to U(https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk25164).
        type: bool
      ...
      endpoint_policy:
        description:
          - Enable Endpoint Policy.
            To complete Endpoint Security Management configuration, perform Install Database on your Endpoint Management Server.
            Field is not supported on Multi Domain Server environment.
        type: bool
      compliance:
        description:
          - Compliance blade.
            Can be set when 'network_policy_management' was selected to be True.
        type: bool
      user_directory:
        description:
...
EXAMPLES = """
- name: add new SmartEvent checkpoint-host
...
def main():
    argument_spec = dict(
        ...
        interfaces=dict(type='list', options=dict(
            ...
            subnet_mask=dict(type='int'),
            color=dict(type='str', choices=['aquamarine', 'black', 'blue', 'crete blue', 'burlywood', 'cyan', 'dark green',
                                            'khaki', 'orchid', 'dark orange', 'dark sea green', 'pink', 'turquoise', 'dark blue', 'firebrick', 'brown',
                                            'forest green', 'gold', 'dark gold', 'gray', 'dark gray', 'light green', 'lemon chiffon', 'coral',
                                            'sea green', 'sky blue', 'magenta', 'purple', 'slate blue', 'violet red', 'navy blue', 'olive', 'orange', 'red', 'sienna',
                                            'yellow']),
        ...
        logs_settings=dict(type='dict', options=dict(
            ...
            alert_when_free_disk_space_below_type=dict(type='str', choices=['none', 'log', 'popup alert', 'mail alert',
            ...
            smart_event_intro_correlation_unit=dict(type='bool'),
